class Class {
  ...
  final double? ecolage;
  final double? fraisCotisationParallele;
  final double? fraisInscription; // Frais pour nouveaux élèves uniquement
  final String? level;
  ...
  factory Class.fromMap(Map<String, dynamic> map) {
    return Class(
      ...
      ecolage: map['ecolage'] != null
          ? (map['ecolage'] as num).toDouble()
          : (map['fraisEcole'] != null ? (map['fraisEcole'] as num).toDouble() : null),
      fraisCotisationParallele: map['fraisCotisationParallele'] != null
          ? (map['fraisCotisationParallele'] as num).toDouble()
          : null,
      fraisInscription: map['fraisInscription'] != null
          ? (map['fraisInscription'] as num).toDouble()
          : null,
