...
class ReportCardPdfService {
  ...
  static Future<List<int>> generateReportCardPdf({
    ...
    final bool denseModeFooter = totalSubjects > (isLandscape ? 22 : 16);
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          ...
          final double headerFont = denseMode
              ? (isLandscape ? 8.5 : 10.0)
              : (isLandscape ? 9.5 : 14.0);
          ...
          return <pw.Widget>[
            ...
            ...(() {
                ...
                if (denseMode) {
                  ...
                  return <pw.Widget>[
                    pw.Row(
                      ...
                      children: [
                        pw.Expanded(
                          child: buildTableForSubjects(left, showTotals: false),
                        ),
                        pw.SizedBox(width: 6),
                        pw.Expanded(
                          child: buildTableForSubjects(
                            right,
                            showTotals: false,
                          ),
                        ),
              ...
              for (final key in orderedKeys) {
                ...
                final String catAvgStr = catCoeffs > 0
                    ? (catPts / catCoeffs).toStringAsFixed(2)
                    : '-';
                ...
                for (final subj in grouped[key]!) {
                  final classSubjGrades = classPeriodGrades
                      .where(
                        (g) =>
                            g.subject == subj &&
                            (g.type == 'Devoir' || g.type == 'Composition') &&
                ...
                final String catClassAvgStr = catClassCoeffs > 0
                    ? (catClassPts / catClassCoeffs).toStringAsFixed(2)
                    : '-';
                sections.add(
                  pw.Container(
                    padding: const pw.EdgeInsets.symmetric(
